...
fun main() {
    ...
    println("The movie ticket price for person aged $child is \$${ticketPrice(child, isMonday)}.")
    println("The movie ticket price for person aged $adult is \$${ticketPrice(adult, isMonday)}.")
    println("The movie ticket price for person aged $senior is \$${ticketPrice(senior, isMonday)}.")
